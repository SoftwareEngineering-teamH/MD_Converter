	...
	public static void main(String[] args) throws IOException
	{
		try{
			...
			else if(args[0].equals("-help"))
			{
				System.out.println("\n\t¢Â Help option"); 
				System.out.println("\n\t=========================================================================================================="); 
				 System.out.println("\t¡ØInput format: <Command_type> <operation_type> <file_name>.....<file_name>\n"); 
			...
			else if(args[0].equals("-read"))
			{
				...
				{
					System.out.println("\n¡Ý "+(args.length-2)+" read was executed.\n");
					try {
							...
							for(int i = 0; i<(args.length)-2; i++)
							{
								...
								else
								{
									...
									else
									{
										...
										System.out.println("\n ¡Ú[Successfully converted]: File <"+ args[i+2]+">was converted to File <"+args[i+2].replace(".md","_slide") +".html"+">¡Ú\n\n"); 
							...
							for(int i = 0; i<(args.length)-2; i++)
							{
								...
								else
								{
									...
									else
									{
										...
										if (null != bufferedWriter)
										System.out.println("\n ¡Ú[Successfully converted]: File <"+ args[i+2]+">was converted to File <"+args[i+2].replace(".md","_fancy") +".html"+">¡Ú\n\n"); 
										bufferedWriter.close();
									}
								}
							}
							...
							for(int i = 0; i<(args.length)-2; i++)
							{
								...
								else
								{
									...
									else
									{
										...
										if (null != bufferedWriter)
										System.out.println("\n ¡Ú[Successfully converted]: File <"+ args[i+2]+">was converted to File <"+args[i+2].replace(".md","_plain") +".html"+">¡Ú\n\n"); 
										bufferedWriter.close();
									}
								}
							}
				...
				{
					System.out.println("\n¡Ý "+(args.length-1)+" read was executed.\n");
					try {
							...
							for(int i = 0; i<(args.length)-1; i++)
							{
								...
								else
								{
									...
									else
									{
										...
										if (null != bufferedWriter)
										System.out.println("\n ¡Ú[Successfully converted]: File <"+ args[i+1]+">was converted to File <"+args[i+1].replace(".md","_plain") +".html"+">¡Ú\n\n"); 
										bufferedWriter.close();
									}
								}
							}
