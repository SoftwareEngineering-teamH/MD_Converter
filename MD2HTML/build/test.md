...
For an introduction and examples, visit the
...
* Attractive default UI theme based on
* A highly customizable slider widget with built-in support for animation.
* Pre-built output widgets for displaying plots, tables, and printed output of R objects.
* Fast bidirectional communication between the web browser and R using the package.
* Uses a programming model that eliminates messy event handling code, so you can focus on the code that really matters.
...
We hope you enjoy using Shiny. If you have general questions about using Shiny, please use the Shiny . For bug reports, please use the
...
If you do not wish to update your code at this time, you can use the  package for backward compatibility.
