               ...
               try {
                  File file = new File(args[2]);
                        ...
                        else
                        {
                           ...
                           {
                              BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(args[2].replace(".md","_slide") +".html"));
               ...
               try {
                  File file = new File(args[2]);
                        ...
                        else
                        {
                           ...
                           {
                              BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(args[2].replace(".md","_fancy") +".html"));
                              Scanner sc = new Scanner(file);
                              while(sc.hasNext()) 
                                {
                                   data += sc.next();
                  ...
                  File file = new File(args[2]);
                     for(int i = 0; i<(args.length)-2; i++)
                     {
                        ...
                        else
                        {
                           ...
                           {
                              BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(args[2].replace(".md","_plain") +".html"));
                              Scanner sc = new Scanner(file);
                              while(sc.hasNext()) 
                                {
                                   data += sc.next();
                  ...
                  File file = new File(args[1]);
                     for(int i = 0; i<(args.length)-1; i++)
                     {
                        ...
                        else
                        {
                           ...
                           {
                              BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(args[1].replace(".md","_plain") +".html"));
                              Scanner sc = new Scanner(file);
                              while(sc.hasNext()) 
                                {
                                   data += sc.next();
